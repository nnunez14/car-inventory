...
def create_car(current_user_token):
    ...
    car = Car(name,description,price,camera_quality,flight_time,max_speed,dimensions,weight,cost_of_prod,series,user_token = user_token)
...
@token_required
def delete_cars(current_user_token, id):
    car = Car.query.get(id)
    if car:
