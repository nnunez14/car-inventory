...
# Creating our Marshaller to pull k,v pairs out of Car instance attributes
class CarSchema(ma.Schema):
    class Meta:
        #detailing which fields to pull out of our car and send to API call
...
# car_1
# a_dict = {}
# for field in car_schema.Meta.fields:
#     a_dict[field] = car_1.field
